...
<div class="container">
    ...
    <div class="row mt-5 p-4">
        ...
        <div class="col-6 col-md-4 col-lg-6">
            <form action="transaksi_menu.php" method="post">
				...
				<div class="form-group">
                    ...
                    <input type="number" min ="20"  class="form-control" id="qty" name="qty"  onkeyup="total()" placeholder="minimal pesan 20pcs">
                </div>
                <div class="form-group ">
                    <label for="exampleInputEmail1">Nama menu</label>
                    <input type="text" class="form-control" id="namapak" name="nama_men"
                        value="<?=@$result['nama_men'] ?>" readonly>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="harga" name="harga_men"
                        value="<?=@$result['harga_men'] ?>" onchange="total()" readonly>
                </div>
