...
<table class="table table-hover">
	<tr>
        ...
        <th class="col-md-1">id login</th>
		<th class="col-md-2">email login</th>
    ...
    <?php 
		...
		<tr>
            <td><?php echo $no++ ?></td>
            <td><?php echo $b['id_login'] ?></td>
            <td><?php echo $b['email'] ?></td>
			<td><?php echo $b['password'] ?></td>
            <td><?php echo $b['level'] ?></td>
		
			<td>
			<button class="btn btn-warning" data-toggle="modal" data-target="#myModal<?php echo $b['id_login']; ?>">Edit</button>
			<a href="act_akun.php?id_login=<?php echo $b['id_login']?>&act=hapus" class="btn btn-danger">Delete</a>
...
<div class="modal fade" id="myModal<?php echo $b['id_login']; ?>">
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" action="act_akun.php" method="post">
                        <?php
                        $id_login = $b['id_login']; 
                        $query = mysqli_query($koneksi, "SELECT * FROM login WHERE id_login='$id_login'");
	...
	<div class="modal-dialog">
		...
		<form action="act_akun.php" method="post">
			...
			<div class="modal-body">
                ...
                <input name="id_login" type="text" class="form-control" placeholder="Harga ..">
            </div>
				<div class="form-group">
					<label>email Papassword</label>
					<input name="email" type="text" class="form-control" placeholder="Jenis Barang ..">
				</div>
				<div class="form-group">
					<label>password</label>
